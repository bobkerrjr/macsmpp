...
DataSm::DataSm() {
#ifdef DEBUG
	cout << "DataSm::DataSm()" << endl;
#endif
	this->init();
}

DataSm::DataSm(char* buffer, uint32_t commandLength) {
#ifdef DEBUG
	cout << "DataSm::DataSm(char* buffer, uint32_t commandLength)" << endl;
#endif
	this->init();
...
void DataSm::init() {
	...
	//TODO: define a message flow to DATA_SM
	this->esm_class.setMessageFlow(0x00);
...
void DataSm::pduDecode(char* buffer, uint32_t commandLength) {
	int i = 0;
	...
	//Copy esm_class, esm_class and data_coding values
